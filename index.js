...
// function for render user cards
function renderUsers(usersArray) {
    usersCon.innerHTML = '';
    usersArray.forEach(user => {
        const card = document.createElement('div');
        card.classList.add('card');
        card.innerHTML = `<p>${user.name}</p>
...
// function for handle add user button click
